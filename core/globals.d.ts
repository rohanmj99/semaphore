...
declare module "qrcode" {
  ...
  function toString(text: string, options?: QRCodeOptions & { type: "terminal" }): Promise<string>;
  const _default: typeof toDataURL & { toDataURL: typeof toDataURL; toString: typeof toString };
